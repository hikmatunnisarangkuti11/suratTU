                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="number" name="name" class="form-control" value="{{ $name; }}" placeholder="Masukan Nama Pengirim.." required>
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="col-md-12">
