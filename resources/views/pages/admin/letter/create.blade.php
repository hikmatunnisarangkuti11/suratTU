                ...
                <div class="row gx-4">
                    <div class="col-lg-9">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3 row">
                                    <label for="letter_type" class="col-sm-3 col-form-label">Klasifikasi Surat</label>
                                    <div class="col-sm-9">
                                        <select name="letter_type" class="form-control" required>
                                            <option value="">Pilih..</option>
                                            <option value="Surat Masuk" {{ (old('letter_type') == 'Surat Masuk')? 'selected':''; }}>Rapat Guru</option>
                                            <option value="Surat Keluar" {{ (old('letter_type') == 'Surat Keluar')? 'selected':''; }}>Rapat Penting</option>
                                        </select>
                                    </div>
                                    @error('letter_type')
                                ...
                                <div class="mb-3 row">
                                    <label for="department_id" class="col-sm-3 col-form-label">Role</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="mb-3 row">
                                    <label for="sender_id" class="col-sm-3 col-form-label">Notulis</label>
                                    <div class="col-sm-9">
